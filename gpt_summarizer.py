...
class GptSummarizer:
    ...
    def summarize(self,text):
        response = self.client.chat.completions.create(
            model="gpt-4.1",
            messages=[
                {"role": "system", "content": "You are a text summarization assistant. Return only a very short, concise summary in 3 sentences or less. Keep it brief and avoid excessive highlighting."},
...
# summary = summarizer.summarize(para)
# print("SUMMARY:\n", summary)